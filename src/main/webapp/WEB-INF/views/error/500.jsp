...
<%
    if (exception != null) {
        System.err.println("Error 500 en " + request.getAttribute("javax.servlet.error.request_uri"));
...
<head>
    ...
    <title><%= MessageUtil.getMessage(localeError, "error.500_titulo")%> | DTimer</title>
...
<div class="error-wrapper">
    <div class="error-card">
        ...
        <h1><%= MessageUtil.getMessage(localeError, "error.500_titulo")%></h1>
        <p class="error-text"><%= MessageUtil.getMessage(localeError, "error.500_texto")%></p>
